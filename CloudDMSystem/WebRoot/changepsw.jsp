      ...
      <div class="row-fluid">
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li ><a href="userinf.jsp">个人信息</a></li>
              <li ><a href="updateuser.jsp">更新信息</a></li>
              <li class="active"><a href="changepsw.jsp">修改密码</a></li>
       ...
       <div class="span9">
		  <div class="row-fluid">
			...
			<form class="form-horizontal" action="/CloudDMSystem/changepsw" method="post">
				<fieldset>
					...
					<div class="control-group">
						<label class="control-label" for="newpassword1">确定密码</label>
						<div class="controls">
